...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dwarf_sMagicShop.Domain.Models.ArtefactSpecies", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("artefacts_species", (string)null);
                });

            modelBuilder.Entity("Dwarf_sMagicShop.Domain.Models.Crafter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("crafters", (string)null);
                });

            modelBuilder.Entity("Dwarf_sMagicShop.Domain.Models.CrafterBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("crafter_balance", (string)null);
                });

            modelBuilder.Entity("Dwarf_sMagicShop.Domain.Models.MagicArtefact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.ToTable("magic_artefacts", (string)null);
                });

            modelBuilder.Entity("Dwarf_sMagicShop.Domain.Models.MagicArtefact", b =>
                {
                    b.HasOne("Dwarf_sMagicShop.Domain.Models.Crafter", null)
                        .WithMany("Artefacts")
