...
public interface IAccountRepository
{
	...
	Task<Result<User, Error>> GetUserByNameAsync(string userName, CancellationToken cancellationToken);
	...
	Task<Result<User, Error>> GetUserByIdAsync(string userId, CancellationToken cancellationToken);
}
